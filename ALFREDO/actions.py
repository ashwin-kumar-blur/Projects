...
class Inform_Action(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		Details = """The death count  for {} is {} and the count for recovered cases is {} 
		while there are {} total number of reported cases
		.""".format(loc,deaths,recovered,total_case)
		
		dispatcher.utter_message("what is this: {}".format(loc))
